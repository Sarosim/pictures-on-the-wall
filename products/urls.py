...
from products.views import all_products, product_details, filtered_products, file_upload, modify_artwork, delete_artwork, delete_confirm, rate_artwork, sort_and_filter, like_artwork
...
urlpatterns = [
    ...
    url(r'^like/', like_artwork, name = "like_artwork"),
]